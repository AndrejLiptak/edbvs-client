...
export function AdminDevice({ devices, postDevice, type }: Props) {
  ...
  const columns: GridColDef[] = [
    ...
    ...(type != "Enclosure"
      ? [{ field: "inputs", headerName: "Inputs", width: 70, type: "number" }]
      : []),

    ...(type != "Enclosure"
      ? [{ field: "outputs", headerName: "Outputs", width: 70, type: "number" }]
      : []),
    ...(type != "Enclosure"
      ? [{ field: "slots", headerName: "Slots", width: 70, type: "number" }]
      : []),
    ...(type != "Enclosure"
      ? [
          {
            field: "powerLoss",
            headerName: "Power loss",
            width: 100,
            type: "number",
          },
        ]
    ...
    ...(type == "Enclosure"
      ? [
          {
            field: "totalDIN",
            headerName: "Total DINs",
            width: 150,
            type: "number",
          },
        ]
      : []),
    ...(type == "CircuitBreaker" || type == "RCD"
      ? [
          {
            field: "poleCount",
    ...
    ...(type == "CircuitBreaker" || type == "RCD"
      ? [
          {
            field: "ratedCurrent",
            headerName: "Rated current",
            width: 150,
            type: "number",
          },
        ]
      : []),
    ...(type == "CircuitBreaker" || type == "SurgeProtector"
      ? [{ field: "type", headerName: "Type", width: 50, type: "string" }]
      : []),
    ...(type == "RCD"
      ? [
          {
            field: "ratedResidualCurrent",
            headerName: "Residual current",
            width: 150,
            type: "number",
          },
        ]
    ...
    ...(type == "RCD"
      ...
      : []),
    ...(type == "PLC"
      ? [{ field: "digitalIn", headerName: "DI", width: 50, type: "string" }]
      : []),
    ...(type == "PLC"
      ? [{ field: "digitalOut", headerName: "DO", width: 50, type: "string" }]
      : []),
    ...(type == "PLC"
      ? [{ field: "analogIn", headerName: "AI", width: 50, type: "string" }]
      : []),
    ...(type == "PLC"
      ? [{ field: "analogOut", headerName: "AO", width: 50, type: "string" }]
      : []),
    {
      field: "link",
      headerName: "Link",
